  ...
  return (
    <div className="bg-[#131b2e] border border-[#1e293b] rounded-xl p-4 space-y-3">
      <div className="flex flex-wrap items-center gap-3">
        ...
        {/* View mode toggle */}
        <div className="relative flex bg-[#0b0f19] border border-slate-700 rounded-lg p-1">
          <motion.div
            className="absolute inset-y-1 w-[calc(50%-4px)] bg-cyan-600 rounded-md"
            animate={{ x: viewMode === "folder" ? 2 : "calc(100% + 6px)" }}
          ...
          <button
            ...
            className={`relative z-10 flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium transition-colors cursor-pointer ${
              viewMode === "folder" ? "text-white" : "text-slate-400 hover:text-white"
            }`}
          >
          ...
          <button
            ...
            className={`relative z-10 flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium transition-colors cursor-pointer ${
              viewMode === "table" ? "text-white" : "text-slate-400 hover:text-white"
            }`}
          >
